  ...
  Team.where(name: clan).each do |team|
    ...
    case clan
      ...
      when 'green'
        ...
        questionaire.questions.create(statement: 'Fishing', description: 'Answer questions to get five letters.', answer: 'TITLE', hint: "Fishing doesn't impress anyone.", category: 'Word')

        questionaire.questions.create(statement: 'US Crossword', description: "Solve terms with a 'dot' iin them. SUTTER 23D,EXECUTIVE 17R, SEGREGATION 9D, CARTER 31R", answer: '', hint: '', category: 'Directional')
      ...
      when 'yellow'
        ...
        questionaire.questions.create(statement: 'Subtraction Action', description: 'Do all problems. Add all answers. Convert to letters using cipher. 79480', answer: 'SPORE', hint: 'Add all answers together. Convert to a word using given system.', category: 'Word')
      ...
      when 'pink'
        ...
        questionaire.questions.create(statement: 'Epic Center', description: 'Find difference of P and S waves.Use graph to find distance, which leads to 5 letters.', answer: 'FRESH', hint: 'Find the difference of P and S waves. Use graph to find distance.', category: 'Word')
      ...
      when 'blue'
        ...
        questionaire.questions.create(statement: 'Mappetite', description: 'Denver, Des Moines, Tallahassee, Columbus, Pierre. Find which states these are capitals. Letters in map spell code. Colorado=O, Iowa=Z, Florida=A, Ohio=R, South Dakota=K', answer: 'OZARK', hint: 'Which states have these capitals?', category: 'Word')
