  ...
  Team.where(name: clan).each do |team|
    ...
    case clan
      ...
      when 'green'
        ...
        questionaire.questions.create(statement: 'US Crossword', description: "Solve terms with a 'dot' iin them. SUTTER 23D,EXECUTIVE 17R, SEGREGATION 9D, CARTER 31R", answer: '', hint: '', category: 'Word')
