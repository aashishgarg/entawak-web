class Questionaire < ApplicationRecord
  ...
  def populate_questions
    case name
      ...
      #purple
      when 'purple'
        questions.create(statement: 'Exploration', description: 'No CAGE could hold these explorers.Which numbers match with CAGE? C=4,A=2,G=3,E=5', answer: '4235', hint: 'Which numbers spell CAGE?', category: '4 Number')
