  ...
  def populate_questions
    case name
      ...
      when 'red'
        ...
        questions.create(statement: 'Africa in Pieces', description: 'Which countries have the given independence days. Letters spell the answer. Uganda (W), Egypt (O), Chad (R), Botswana (L), Morocco (D)', answer: 'WORLD', hint: 'Hint: Which countries have these independence dates?', category: 'Word')
      ...
      when 'green'
        ...
        questions.create(statement: 'Landformula', description: 'Answer questions. Questions where the second word is correct give the digits.', answer: '145', hint: "Which question's answers are the second word?", category: 'Word')


        questions.create(statement: 'Speech Teach', description: 'Put Gettysburg Address in order.Numbers spell code.', answer: '2724', hint: 'Google the first line to find which speech.Put in order to find number code.', category: 'Word')

        questions.create(statement: 'Fishing', description: 'Answer questions to get five letters.', answer: 'TITLE', hint: "Fishing doesn't impress anyone.", category: 'Word')

        questions.create(statement: 'US Crossword', description: "Solve terms with a 'dot' iin them. SUTTER 23D,EXECUTIVE 17R, SEGREGATION 9D, CARTER 31R", answer: '', hint: '', category: 'Word')
      ...
      when 'yellow'
        ...
        questions.create(statement: 'Subtraction Action', description: 'Do all problems. Add all answers. Convert to letters using cipher. 79480', answer: 'SPORE', hint: 'Add all answers together. Convert to a word using given system.', category: 'Word')
      ...
      when 'pink'
        ...
        questions.create(statement: 'Epic Center', description: 'Find difference of P and S waves.Use graph to find distance, which leads to 5 letters.', answer: 'FRESH', hint: 'Find the difference of P and S waves. Use graph to find distance.', category: 'Word')
      ...
      when 'blue'
        ...
        questions.create(statement: 'Mappetite', description: 'Denver, Des Moines, Tallahassee, Columbus, Pierre. Find which states these are capitals. Letters in map spell code. Colorado=O, Iowa=Z, Florida=A, Ohio=R, South Dakota=K', answer: 'OZARK', hint: 'Which states have these capitals?', category: 'Word')
      ...
      when 'purple'
        ...
        questions.create(statement: 'Earthwords', description: 'The first letter of the answers for 38456. The first letter of the answer for question 3, 8, 4, 5, 6 in order.', answer: 'TIRED', hint: 'Lithosphere contains up parts of two layers.', category: 'Word')
